...
if page=='ATD prediction':
    ...
    var_pickup_distance=st.sidebar.slider(label='Pickup distance', min_value=0,  max_value=40)
    var_dropoff_distance=st.sidebar.slider(label='Dropoff distance', min_value=0, max_value=120)
